...
## [22.0.1](https://github.com/bluealloy/revm/compare/revm-v22.0.0...revm-v22.0.1) - 2025-04-10

### Other

- updated the following local packages: revm-primitives, revm-interpreter, revm-precompile, revm-handler, revm-inspector, revm-bytecode, revm-state, revm-database-interface, revm-context-interface, revm-context, revm-database
